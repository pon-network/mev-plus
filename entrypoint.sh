...
"erigon.dnp.dappnode.eth") EXECUTION_LAYER="http://erigon.dappnode:8544" ;;
*)
...
if [ -n "$_DAPPNODE_GLOBAL_MEVBOOST_MAINNET" ] && [ "$_DAPPNODE_GLOBAL_MEVBOOST_MAINNET" == "true_alongside_plus" ]; then
