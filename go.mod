module github.com/pon-network/mev-plus
...
require (
	...
	github.com/bsn-eng/pon-golang-types v0.0.0-20240314072356-c8bbbf398d5f
	...
	github.com/restaking-cloud/native-delegation-for-plus v0.6.0
